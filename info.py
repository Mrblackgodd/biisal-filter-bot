...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002199450162').split()]
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1001748572062'))
